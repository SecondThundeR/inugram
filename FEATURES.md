...
- configurable confirmation after biometric recognition, separately for app unlock, mini apps, and protected chat deletion/history clearing/logout; applies to the next prompt without restarting
